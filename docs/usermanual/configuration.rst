...
.. hint::
    Achtung: Der Default für die Steigung (Slope) jedes Kalibrierungswertes ist ``1``. Wird hier eine ``0`` eingetragen, wird jeder Datenwert auch auf 0 gesetzt. Der Default für die Konfigurationsparameter **Offset** und **Smoothin** ist ``0``.
