...
.. warning::
	Wenn der Wifi Client-Modus aktiviert ist, versucht das Gerät etwa einmal pro Minute sich mit dem konfigurierten WLAN zu verbinden. Während dieses Verbindungsversuchs ist das vom Gerät selbst erzeugte WLAN ( siehe :ref:`Config - System` ) nicht verfürbar.
